...
# *   Acepte dos parámetros: el primero la cantidad objetivo de agua a separar,
# *   el segundo una lista de números enteros que serán las distintas jarras de agua de que disponemos (por ejemplo, una de 3 litros y otra de 5 --> [3, 5])
...
def water_pitcher(agua_a_separar: int, jarras: list):
    pass
